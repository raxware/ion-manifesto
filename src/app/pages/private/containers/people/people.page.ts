...
@Component({
  ...
  standalone: true,
  imports: [IonFabList, IonFabButton, IonFab, IonSegmentButton, IonSegment, IonSearchbar, 
    IonButton, IonItemDivider, IonCol, IonRow, IonGrid, 
...
export class PeoplePage implements OnInit {
  ...
  @Input() containerName: string = ('Person');
